    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data['datanew'], function (key, value) {
                rows = rows + '<a href="#" class="dropdown-item"><i class="fas fa-shopping-cart mr-2"></i>';
                rows = rows + value.nama+' Membuat Order Baru <br> <span class="text-muted text-sm">'+value.created_at+'</span>';
